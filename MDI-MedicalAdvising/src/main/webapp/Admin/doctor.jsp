        ...
        <div class="main-panel" id="top">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Quản lí bác sĩ </h3>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover display" id="usertable">
                                    ...
                                    <c:forEach items="${doctors}" var="doctor">
                                        <tr>
                                            <td> ${doctor.getId()}</td>
                                            <td> ${doctor.getIdentityCard()}</td>
                                            <td> ${doctor.getFullName()}</td>
                                            <td> ${doctor.getAccount().getUserName()}</td>
                                            <td> ${doctor.getEducation()}</td>
                                            <td> ${doctor.getSpecialized()}</td>
                                            <td> ${doctor.getNumberPhone()}</td>
                                            <td> ${doctor.getAccount().getEmail()}</td>
                                            <td> ${doctor.getAddress()}</td>
                                            <td>
                                                <a href="/admin?actionUser=editDoctor&id=${doctor.getId()}">
                                                    <button class="btn btn-sm btn-icon-text btn-gradient-dark btn-edit">
                                                        <i
                                                                class=" btn-icon-prepend far fa-edit"></i>Sửa
                                                    </button>
                                                </a>
                                                <button class="btn btn-sm btn-icon-text btn-gradient-danger btn-delete" data-toggle="modal" data-target="#deleteModal-${doctor.getId()}">
                                                    <i class=" btn-icon-prepend fas fa-trash-alt"></i>Xóa
                                                </button>
                                                    <%--Modal delete--%>
                                                <div class="modal fade" id="deleteModal-${doctor.getId()}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Bạn có muốn xoá bác sĩ ${doctor.getFullName()} không?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                        data-dismiss="modal">Quay lại
                                                                </button>
                                                                <a href="/admin?actionUser=deleteDoctor&id=${doctor.getId()}">
